...
get_filename_component(_filename "/home/vihaan/Workspace/Project_Robo-ND_Robotic-Arm_Pick-And-Place/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm/srv/CalculateIK.srv" NAME_WE)
add_custom_target(_kuka_arm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "kuka_arm" "/home/vihaan/Workspace/Project_Robo-ND_Robotic-Arm_Pick-And-Place/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm/srv/CalculateIK.srv" "geometry_msgs/Quaternion:geometry_msgs/Pose:geometry_msgs/Point:trajectory_msgs/JointTrajectoryPoint"
)
...
_generate_srv_cpp(kuka_arm
  "/home/vihaan/Workspace/Project_Robo-ND_Robotic-Arm_Pick-And-Place/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm/srv/CalculateIK.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/kuka_arm)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/kuka_arm\")")
  # install generated code
  install(
